...
namespace ProjetoFinal
{
	public partial class FormCliente : Form
	{
		...
		int MontarCliente() // retorna 1 se montar cliente com sucesso.
		{
			...
			try
			{
				var e = new Endereco(txtLougradouro.Text, txtNumero.Text, txtBairro.Text, txtCidade.Text, txtCep.Text, cmbUf.Text);
		...
		{ // return 1,-1,-2 (Montagem cliente) return -4 cpf vazio e -3 ja existe
			var cpf = ConfereCpf();
		...
		int EditarCliente()
		{
			var criacaoCliente = MontarCliente();
